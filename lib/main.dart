  ...
  void main() async {
    ...
    await Future.wait([store.load(), themeNotifier.load(), categoryStore.load(), walletStore.load(), initializeDateFormatting('id', null)]);
    ...
    runApp(MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: walletStore),
      ],
